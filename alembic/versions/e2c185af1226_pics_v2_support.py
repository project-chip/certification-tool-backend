...
def upgrade():
    ...
    op.add_column("testrunexecution",sa.Column("certification_mode", sa.Boolean(), nullable=False, default=False),)
    op.add_column("testsuiteexecution",sa.Column("mandatory", sa.Boolean(), nullable=False, default=False),)
