...
PYTHON_TESTING_DATA_MODEL_PATH="$TEST_COLLECTIONS_SDK_CHECKOUT_PATH/python_testing/data_model"
...
# Copy SDK data_model folder
cd "$SDK_PATH/$SDK_PYTHON_DATA_MODEL_PATH"
cp -R * "$PYTHON_TESTING_DATA_MODEL_PATH/"
