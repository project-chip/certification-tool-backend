...
THREAD_ACTIVE_DATASET_FILE_DEFAULT_NAME = "thread_active_dataset.hex"
THREAD_ACTIVE_DATASET_FILE_HOST = ADMIN_STORAGE_FILE_HOST_PATH.joinpath(
    THREAD_ACTIVE_DATASET_FILE_DEFAULT_NAME
)
