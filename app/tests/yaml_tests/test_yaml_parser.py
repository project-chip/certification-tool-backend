...
from test_collections.sdk_tests.sdk_checkout.yaml_tests.models.yaml_test_parser import (
    YamlParserException,
    YamlTest,
    _test_type,
    parse_yaml_test,
...
def test_yaml_file_parser_throws_validationexception() -> None:
    ...
    with mock.patch(
        "test_collections.sdk_tests.sdk_checkout.yaml_tests.models.yaml_test_parser.open",
