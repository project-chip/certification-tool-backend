...
async def test_manual_suite_setup_cleanup() -> None:
    ...
    with mock.patch.object(
        ...
        "test_collections.sdk_tests.sdk_checkout.yaml_tests.models.test_suite.YamlTestSuite.setup"
    ) as _, mock.patch(
        "test_collections.sdk_tests.sdk_checkout.yaml_tests.models.test_suite.YamlTestSuite.cleanup"
    ) as _:
        await suite_instance.setup()
